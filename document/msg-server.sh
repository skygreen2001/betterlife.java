...
# java -jar -Xmx256m /var/msgserver/msgserver.jar /tmp 2>> /dev/null >> /dev/null & echo $! > /tmp/msg-server-pid
### END INIT INFO

SERVICE_NAME=msg-server
PATH_TO_JAR=/var/msgserver/msgserver.jar
OPTS="-Xmx256m"
PID_PATH_NAME=/tmp/msg-server-pid
